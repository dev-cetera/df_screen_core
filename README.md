[![banner](https://github.com/dev-cetera/df_screen_core/blob/v0.5.8/doc/assets/banner.png?raw=true)](https://github.com/dev-cetera)

[![pub](https://img.shields.io/pub/v/df_screen_core.svg)](https://pub.dev/packages/df_screen_core)
[![tag](https://img.shields.io/badge/Tag-v0.5.8-purple?logo=github)](https://github.com/dev-cetera/df_screen_core/tree/v0.5.8)
...
🔍 For more information, refer to the [API reference](https://pub.dev/documentation/df_screen_core/).
